...
import { jenisTagihanForm } from './jenis-tagihan-form';
...
import { tomSelectPegawai } from './tom-select-pegawai';
...
Alpine.data('persetujuanRaporFilter', persetujuanRaporFilter);
Alpine.data('catatanWaliKelasForm', catatanWaliKelasForm);
Alpine.data('raporWaliKelasFilter', raporWaliKelasFilter);
Alpine.data('riwayatIzinCutiSPA', riwayatIzinCutiSPA);
Alpine.data('approvalIzinCutiSPA', approvalIzinCutiSPA);
...
Alpine.data('jenisTagihanForm', jenisTagihanForm);
