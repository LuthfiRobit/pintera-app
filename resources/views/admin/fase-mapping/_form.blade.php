    ...
    <div class="p-6">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-12">
            ...
            @elseif (! $mapping)
                <div class="sm:col-span-12">
                    <x-input-label value="Berlaku Untuk" />
                    <p class="mt-1.5 rounded-lg border border-gray-100 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-600">Mapping ini akan dibuat untuk lembaga yang sedang aktif di sesi Anda.</p>
                </div>
            @else
                <div class="sm:col-span-12">
                    <x-input-label value="Berlaku Untuk" />
                    <p class="mt-1.5 rounded-lg border border-gray-100 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-600">{{ $mapping->lembaga?->nama ?? '— Global (semua lembaga) —' }}</p>
                </div>
            @endif
