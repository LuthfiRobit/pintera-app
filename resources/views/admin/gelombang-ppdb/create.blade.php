<x-app-layout>
    <div class="mx-auto max-w-6xl space-y-4">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <h1 class="font-display text-lg font-bold text-gray-900">Tambah Gelombang &mdash; {{ $tahunAjaranAktif->nama }}</h1>
        ...
        <form method="POST" action="{{ route('admin.gelombang-ppdb.store') }}">
            @csrf
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-card">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <div class="sm:col-span-2 lg:col-span-3">
                        ...
                        <x-text-input type="text" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Gelombang 1" class="mt-1.5" />
            ...
            <div class="mt-4 flex items-center gap-3">
                <x-primary-button type="submit">Simpan Gelombang</x-primary-button>
