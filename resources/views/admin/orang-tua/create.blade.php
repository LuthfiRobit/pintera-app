<x-app-layout>
    <div class="mx-auto max-w-5xl space-y-6">
        ...
        <form method="POST" action="{{ route('admin.orang-tua.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-between rounded-2xl border border-brand-100 bg-brand-50/50 p-5">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-bold text-gray-900">Formulir Pendaftaran Orang Tua / Wali Baru</h3>
                        <p class="text-xs text-gray-500">Isi kelengkapan data orang tua. NIK otomatis menjadi username.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 rounded-2xl border border-gray-200 bg-white p-4 shadow-card">
                <a href="{{ route('admin.orang-tua.index') }}" class="rounded-xl border border-gray-300 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 active:scale-95">
                    Batal
                </a>
