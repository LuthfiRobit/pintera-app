...
@php
    $baseClasses = 'w-full rounded-lg text-sm shadow-sm px-3.5 py-2.5 transition-all focus:outline-none focus:ring-4 disabled:bg-gray-50 disabled:text-gray-500 disabled:cursor-not-allowed';
    $stateClasses = $error 
