                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-12">
                        <div class="sm:col-span-8">
                            ...
                            <x-text-input type="text" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Kelas Rendah (1-3), Kelas Tinggi (4-6), Reguler Pagi" class="mt-1.5 w-full transition duration-150" />
