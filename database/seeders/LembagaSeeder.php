    ...
    public function run(): void
    {
        ...
        Lembaga::firstOrCreate(
            ...
            [
                ...
                'bujur' => '107.6134000',
                'telepon' => '022-7301234',
                'email' => 'smp@permata.sch.id',
                'website' => 'https://smp.permata.sch.id',
                'nama_bank' => 'Bank BRI',
                'cabang_kcp_unit' => 'KCP Bandung Cibeunying',
                'rekening_atas_nama' => 'SMP Permata',
                'nomor_rekening' => '0123-01-987654-50-1',
                'mbs' => true,
                'nama_wajib_pajak' => 'SMP Permata',
        ...
        Lembaga::firstOrCreate(
            ...
            [
                ...
                'bujur' => '107.6138000',
                'telepon' => '022-7301235',
                'email' => 'sma@permata.sch.id',
                'website' => 'https://sma.permata.sch.id',
                'nama_bank' => 'Bank BRI',
                'cabang_kcp_unit' => 'KCP Bandung Cibeunying',
                'rekening_atas_nama' => 'SMA Permata',
                'nomor_rekening' => '0123-01-987655-50-2',
                'mbs' => true,
                'nama_wajib_pajak' => 'SMA Permata',
