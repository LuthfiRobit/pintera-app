    ...
    private function seedSmpKomponen(Lembaga $smp, Semester $semester): void
    {
        ...
        if ($mtk) {
            KomponenPenilaian::firstOrCreate(
                ...
                ['deskripsi' => 'Peserta didik dapat menyelesaikan operasi aritmetika pada bilangan bulat dan pecahan.', 'bobot' => 50, 'kktp' => 'Minimal 75% benar']
            );
            KomponenPenilaian::firstOrCreate(
                ['mata_pelajaran_id' => $mtk->id, 'semester_id' => $semester->id, 'kode' => 'TP.1.2'],
                ['deskripsi' => 'Peserta didik mendeskripsikan dan mengekspresikan relasi serta fungsi dengan representasi grafik.', 'bobot' => 50, 'kktp' => 'Mampu menggambar grafik linier']
            );
        }
        ...
        if ($ipa) {
            KomponenPenilaian::firstOrCreate(
                ...
                ['deskripsi' => 'Peserta didik memahami besaran pokok dan besaran turunan dalam satuan internasional.', 'bobot' => 100, 'kktp' => 'Tepat menggunakan alat ukur']
            );
        }
    }
    ...
    private function seedGenericKomponen(Lembaga $lembaga, Semester $semester): void
    {
        ...
        foreach ($mapelList as $mapel) {
            KomponenPenilaian::firstOrCreate(
                ...
                ['deskripsi' => "Tujuan Pembelajaran Dasar untuk mata pelajaran {$mapel->nama}.", 'bobot' => 100, 'kktp' => 'Tercapai Sesuai Kriteria']
            );
        }
    }
}
